...
async function deleteItem(cartId) {
    await axios.get('/sanctum/csrf-cookie')
    await axios.post('/user/cart-destroy', {
            cart_id: cartId,
        })   
...
async function deleteSelected() {
    ...
    await axios.get('/sanctum/csrf-cookie')
    await axios.post('/user/destroy-carts', {
            check: selectedIds.value,
        })  
...
function checkout() {
    cartStore.requestAction = 'cart-to-checkout'
    cartStore.selectedIds = selectedIds.value
