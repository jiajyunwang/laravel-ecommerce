...
function getSingleElementRoot(root2) {
  const children = root2.children.filter((x) => x.type !== 3);
...
function walk(node, parent2, context, doNotHoistNode = false, inFor = false) {
  ...
  if (toCache.length === children.length && node.type === 1) {
    ...
    } else if (node.tagType === 3 && parent2 && parent2.type === 1 && parent2.tagType === 1 && parent2.codegenNode && parent2.codegenNode.type === 13 && parent2.codegenNode.children && !isArray(parent2.codegenNode.children) && parent2.codegenNode.children.type === 15) {
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
    ...
    isStaticPropertyKey = (node, parent2) => isStaticProperty(parent2) && parent2.key === node;
    TS_NODE_TYPES = [
      "TSAsExpression",
      // foo as number
      "TSTypeAssertion",
...
function isValidHTMLNesting(parent2, child) {
  if (parent2 === "template") {
    return true;
  }
  if (parent2 in onlyValidChildren) {
    return onlyValidChildren[parent2].has(child);
  }
  if (child in onlyValidParents) {
    return onlyValidParents[child].has(parent2);
  }
  if (parent2 in knownInvalidChildren) {
    if (knownInvalidChildren[parent2].has(child)) return false;
  }
  if (child in knownInvalidParents) {
    if (knownInvalidParents[child].has(parent2)) return false;
  }
  return true;
}
...
var require_vue_cjs = __commonJS({
  "node_modules/vue/dist/vue.cjs.js"(exports2) {
    ...
    function compileToFunction(template2, options) {
      ...
      const key = shared.genCacheKey(template2, options);
...
function equalArrays(array, other, bitmask, customizer, equalFunc, stack2) {
  ...
  var index = -1, result2 = true, seen2 = bitmask & COMPARE_UNORDERED_FLAG ? new SetCache_default() : void 0;
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack2) {
  switch (tag) {
    ...
    case setTag6:
      ...
      var result2 = equalArrays_default(convert(object), convert(other), bitmask, customizer, equalFunc, stack2);
...
function baseIntersection(arrays, iteratee2, comparator) {
  ...
  outer:
    while (++index < length && result2.length < maxLength) {
      ...
      value = comparator || value !== 0 ? value : 0;
      if (!(seen2 ? cacheHas_default(seen2, computed) : includes2(result2, computed, comparator))) {
        othIndex = othLength;
        while (--othIndex) {
...
function basePullAll(array, values2, iteratee2, comparator) {
  var indexOf2 = comparator ? baseIndexOfWith_default : baseIndexOf_default, index = -1, length = values2.length, seen2 = array;
  if (array === values2) {
    values2 = copyArray_default(values2);
  }
  if (iteratee2) {
    seen2 = arrayMap_default(array, baseUnary_default(iteratee2));
  }
  while (++index < length) {
...
function baseSortedUniq(array, iteratee2) {
  ...
  while (++index < length) {
    var value = array[index], computed = iteratee2 ? iteratee2(value) : value;
    if (!index || !eq_default(computed, seen2)) {
      var seen2 = computed;
...
function baseUniq(array, iteratee2, comparator) {
  var index = -1, includes2 = arrayIncludes_default, length = array.length, isCommon = true, result2 = [], seen2 = result2;
  if (comparator) {
    isCommon = false;
    includes2 = arrayIncludesWith_default;
...
var VERSION, WRAP_BIND_KEY_FLAG7, LAZY_FILTER_FLAG2, LAZY_WHILE_FLAG, MAX_ARRAY_LENGTH7, arrayProto6, objectProto30, hasOwnProperty26, symIterator2, nativeMax17, nativeMin15, mixin2, lodash_default_default;
...
var require_ckeditor = __commonJS({
  "node_modules/@ckeditor/ckeditor5-vue/dist/ckeditor.js"(exports2, module2) {
    !(function(e, t) {
      "object" == typeof exports2 && "object" == typeof module2 ? module2.exports = t(require_vue(), (init_lodash(), __toCommonJS(lodash_exports))) : "function" == typeof define && define.amd ? define(["vue", "lodash-es"], t) : "object" == typeof exports2 ? exports2.CKEditor = t(require_vue(), (init_lodash(), __toCommonJS(lodash_exports))) : e.CKEditor = t(e.vue, e["lodash-es"]);
    })(self, (e, t) => (() => {
      "use strict";
      var i = { 76: (e2) => {
        e2.exports = t;
      ...
      n.d = (e2, t2) => {
        for (var i2 in t2) n.o(t2, i2) && !n.o(e2, i2) && Object.defineProperty(e2, i2, { enumerable: true, get: t2[i2] });
      ...
      return (() => {
        ...
        const i2 = (0, e2.defineComponent)({ name: "Ckeditor", model: { prop: "modelValue", event: "update:modelValue" }, props: { editor: { type: Function, required: true }, config: { type: Object, default: () => ({}) }, modelValue: { type: String, default: "" }, tagName: { type: String, default: "div" }, disabled: { type: Boolean, default: false }, disableTwoWayDataBinding: { type: Boolean, default: false } }, emits: ["ready", "destroy", "blur", "focus", "input", "update:modelValue"], data: () => ({ instance: null, lastEditorData: null }), watch: { modelValue(e3) {
          ...
          if (!e3) return console.warn('Cannot find the "CKEDITOR_VERSION" in the "window" scope.');
        ...
        if (!e2.version || !e2.version.startsWith("3.")) throw new Error("The CKEditor plugin works only with Vue 3+. For more information, please refer to https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/vuejs-v3.html");
        const o2 = { install(e3) {
