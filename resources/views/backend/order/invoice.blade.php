...
<head>
    ...
    <style>
        ...
        :root{ --bs-blue:#0d6efd;
            ...
            --bs-light:#f8f9fa;
            --bs-dark:#212529;
            --bs-font-sans-serif:"nstc",system-ui,-apple-system,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans","Liberation Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji","noto sans tc";
